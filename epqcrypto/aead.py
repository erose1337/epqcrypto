...
def encrypt(data='', key='', mac_key=None, iv=None, extra_data='', algorithm="SHA256",
            mode=None, return_mode="cryptogram", backend=None, iv_size=16, hash_algorithm="sha512"):        
...
def _hash_stream_cipher_hkdf(data, key, seed, algorithm="sha512"):
    data = bytearray(data)    
...
def _encrypt(data, key, mac_key, nonce='', extra_data='', algorithm="sha512", nonce_size=32, hmac_algorithm="sha512",
